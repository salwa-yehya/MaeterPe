        ...
        <div class="container">
            ...
            <div class="header-action-icon-2">
                <a href="shop-wishlist.html">
                    <img class="svgInject" alt="img" src="{{ asset('frontend/assets/imgs/theme/icons/icon-heart.svg') }}" />
                        ...
                        @foreach ($carts as $cart)
                            <li>
                                <div class="shopping-cart-img">
                                    <a href="{{url('product/details/'.$cart['product']['id'].'/'.$cart['product']['product_name'])}}"><img alt="img" src="{{asset($cart['product']['product_image'])}} " /></a>
                                </div>
                                <div class="shopping-cart-title">
                                    <h4><a href="{{url('product/details/'.$cart['product']['id'].'/'.$cart['product']['product_name'])}}">{{$cart['product']['product_name']}}</a></h4>
                                    @if ($cart['product']['discount_price'] == NULL)
                                        <h4><span>{{$cart->quantity}} × </span>{{$cart['product']['selling_price']}} JD</h4>
                                        
                                    @else
                                        <h4><span>{{$cart->quantity}} × </span>{{$cart['product']['discount_price']}} JD</h4>
                                    @endif
                                </div>
            ...
            @endif
                            ...
                            <div class="header-action-icon-2">
                                <a href="page-account.html" >
                                    <img class="svgInject" alt="img" src="{{ asset('frontend/assets/imgs/theme/icons/icon-user.svg') }}" />
                                </a>
