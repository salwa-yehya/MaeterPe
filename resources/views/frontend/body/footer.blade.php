                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="{{ asset('frontend/assets/imgs/theme/logo-web.png') }}" alt="logo" /></a>
                        </div>
                        <ul class="contact-infor">
                            <li><i class="fa-solid fa-location-dot" ></i><strong>Address: </strong> <span>JORDEN - AQABA</span></li>
                            <li><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                            <li><strong>Email:</strong><span>sale@Nest.com</span></li>
                            <li><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span></li>
                        </ul>
                    </div>
                </div>
